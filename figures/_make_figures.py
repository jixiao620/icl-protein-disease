...
# G: v6 = 0.4215, v7 = 0.5071, v8 = 0.5140, v9 = 0.4365, v11 = 0.5972
# v11 for I/C currently training; v11 for G is the confirmed best.
i_scores = [0.6953, 0.7761, 0.7980, 0.8363, np.nan]
c_scores = [0.5835, 0.6178, 0.6180, 0.7266, np.nan]
g_scores = [0.4215, 0.5071, 0.5140, 0.4365, 0.5972]
