...
Writes:
  analysis_results/clean_v9_ensemble_eval_i/results.json + summary.csv
"""
...
OUT_DIR   = os.path.join(PROJECT, "analysis_results/clean_v9_ensemble_eval_i")
...
def main():
    ...
    clean_dir = os.path.join(PROJECT, f"processed_data_clean_622_{letter_lower}")
