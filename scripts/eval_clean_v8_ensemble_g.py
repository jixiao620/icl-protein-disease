...
OUT_DIR   = os.path.join(PROJECT, "analysis_results/clean_v8_ensemble_eval_g")
...
N_EVAL_MAX = 10000
BLOCK_LETTER = "G"
CKPT_DIR_TEMPLATE = "checkpoints_clean_v8_ntrain12_g_s{}"
DATA_DIR = "processed_data_clean_ntrain12_g"
...
def main():
    ...
    print(f"\n{'='*70}\n  Block {letter} — v8 protid ENSEMBLE, K={K_EVAL}, "
