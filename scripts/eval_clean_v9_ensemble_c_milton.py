...
OUT_DIR   = os.path.join(PROJECT, "analysis_results/clean_v9_ensemble_eval_c_milton")
os.makedirs(OUT_DIR, exist_ok=True)

SEEDS     = [42, 43, 44]
K_EVAL    = 256            # C block loves larger context — K-sweep sweet spot
N_SEEDS   = 15             # aligned with clean/ntrain/K-sweep/A+B evals
BATCH_QRY = 4  # v9 feat attn heavy              # K=256 + 3-layer perprotattn: shrink batch to avoid OOM
N_EVAL_MAX = 10000
BLOCK_LETTER = "C"
CKPT_DIR_TEMPLATE = "checkpoints_clean_v9_c_s{}"
DATA_DIR = "processed_data_clean_c_milton_c"
...
def main():
    ...
    print(f"\n{'='*70}\n  Block {letter} — v9 featattn ENSEMBLE, K={K_EVAL}, "
