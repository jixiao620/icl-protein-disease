...
#SBATCH --job-name=eval_g_on_i
#SBATCH --output=/work/jl1401/icl_protein_disease/logs/eval_g_on_i_%j.log
#SBATCH --error=/work/jl1401/icl_protein_disease/logs/eval_g_on_i_%j.error
...
python -u scripts/eval_crossblock.py \
  ...
  --output results/g_model_on_i.json \
  --context_size 64 \
  --label "G model -> I test"
