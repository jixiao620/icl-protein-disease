...
#SBATCH --job-name=eval_i_on_c
#SBATCH --output=/work/jl1401/icl_protein_disease/logs/eval_i_on_c_%j.log
#SBATCH --error=/work/jl1401/icl_protein_disease/logs/eval_i_on_c_%j.error
