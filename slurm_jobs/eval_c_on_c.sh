...
#SBATCH --job-name=eval_c_on_c
#SBATCH --output=/work/jl1401/icl_protein_disease/logs/eval_c_on_c_%j.log
#SBATCH --error=/work/jl1401/icl_protein_disease/logs/eval_c_on_c_%j.error
...
python -u scripts/eval_crossblock.py \
  ...
  --output results/c_model_on_c.json \
  --context_size 64 \
  --label "C model -> C test"
