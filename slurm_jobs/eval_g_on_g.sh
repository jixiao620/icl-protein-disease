...
#SBATCH --job-name=eval_g_on_g
#SBATCH --output=/work/jl1401/icl_protein_disease/logs/eval_g_on_g_%j.log
#SBATCH --error=/work/jl1401/icl_protein_disease/logs/eval_g_on_g_%j.error
...
python -u scripts/eval_crossblock.py \
  ...
  --output results/g_model_on_g.json \
  --context_size 64 \
  --label "G model -> G test"
