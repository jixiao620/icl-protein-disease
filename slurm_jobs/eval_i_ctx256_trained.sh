...
#SBATCH --job-name=eval_i_ctx256
#SBATCH --output=/work/jl1401/icl_protein_disease/logs/eval_i_ctx256_%j.log
#SBATCH --error=/work/jl1401/icl_protein_disease/logs/eval_i_ctx256_%j.error
...
python -u scripts/eval_crossblock.py \
  --checkpoint checkpoints_i_ctx256/best_model.pt \
  --data_dir processed_data_full \
  --diseases I11 I119 I129 I15 I110 I13 I151 \
  --output results/i_ctx256_model_on_i.json \
  --context_size 256 \
  --label "I model (train ctx256) -> I test"
