...
#SBATCH --job-name=train_i_ctx64
#SBATCH --output=/work/jl1401/icl_protein_disease/logs/train_i_ctx64_%j.log
#SBATCH --error=/work/jl1401/icl_protein_disease/logs/train_i_ctx64_%j.error
...
echo "=== Train I ctx64 started: $(date) ==="
python -u scripts/train_full_gpt.py --config configs/train_i_ctx64.yaml
echo "=== Done: $(date) ==="
