...
#SBATCH --job-name=train_i_ctx256
#SBATCH --output=/work/jl1401/icl_protein_disease/logs/train_i_ctx256_%j.log
#SBATCH --error=/work/jl1401/icl_protein_disease/logs/train_i_ctx256_%j.error
...
echo "=== Train I ctx256 started: $(date) ==="
python -u scripts/train_full_gpt.py --config configs/train_i_ctx256.yaml
echo "=== Done: $(date) ==="
