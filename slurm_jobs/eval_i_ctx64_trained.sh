...
#SBATCH --job-name=eval_i_ctx64
#SBATCH --output=/work/jl1401/icl_protein_disease/logs/eval_i_ctx64_%j.log
#SBATCH --error=/work/jl1401/icl_protein_disease/logs/eval_i_ctx64_%j.error
...
python -u scripts/eval_crossblock.py \
  --checkpoint checkpoints_i_ctx64/best_model.pt \
  --data_dir processed_data_full \
  --diseases I11 I119 I129 I15 I110 I13 I151 \
  --output results/i_ctx64_model_on_i.json \
  --context_size 64 \
  --label "I model (train ctx64) -> I test"
